...
This script was copied from the sfgastown training system. The 16 hardcoded
scenarios, system prompts, and tool lists are sfgastown-specific and do NOT
match the loraforge training data or pipeline. Do not use for v6+ evals
