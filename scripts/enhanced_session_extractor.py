#!/usr/bin/env python3
"""
Enhanced Session Data Extractor

This script extracts training data from Gas Town agent sessions using the existing
Claude session JSONL files that contain the full conversation history with user/assistant
messages, tool calls, and session IDs.
...
5. Outputs valid OpenAI chat JSONL with system/user/assistant messages
"""
...
# Add the project root to Python path to import data modules
import sys
